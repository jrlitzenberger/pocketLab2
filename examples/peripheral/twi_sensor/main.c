...
#define ARDUINO_I2C_SCL_PIN 15  //7
#define ARDUINO_I2C_SDA_PIN 16 //30
...
#define MMA7660_ADDR        0x68U//(0x98U >> 1)
...
void MMA7660_set_mode(void)
{
    ...
    //err_code = nrf_drv_twi_tx(&m_twi_mma_7660, MMA7660_ADDR, &write, 1, true);  
		err_code = nrf_drv_twi_tx(&m_twi_mma_7660, MMA7660_ADDR, &write, 1, true);
    //err_code = nrf_drv_twi_rx(&m_twi_mma_7660, MMA7660_ADDR, &test,1);
    ...
    switch(p_event->type)
    {
        case NRF_DRV_TWI_EVT_DONE:
                ...
                (p_event->xfer_desc.type == NRF_DRV_TWI_XFER_TX))
            {
                ...
                err_code = nrf_drv_twi_rx(&m_twi_mma_7660, MMA7660_ADDR, &whoami, 1);
								APP_ERROR_CHECK(err_code);
            }
            else
            {
